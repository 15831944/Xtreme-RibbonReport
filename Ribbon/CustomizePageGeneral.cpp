...
BOOL CCustomizePageGeneral::OnInitDialog() 
{
	...
	m_nColor = pMainFrame->m_idRibbonStyle - ID_OPTIONS_STYLE_BLUE2007;
...
void CCustomizePageGeneral::OnOK() 
{
	...
	if (m_nColor != (int)pMainFrame->m_idRibbonStyle - ID_OPTIONS_STYLE_BLUE2007)
	{
		pMainFrame->OnOptionsStyle(m_nColor + ID_OPTIONS_STYLE_BLUE2007);
	}
