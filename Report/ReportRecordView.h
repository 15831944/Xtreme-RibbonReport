...
struct RecordItemCtrlData
{
	...
	RecordItemCtrlData(int column = -1, DWORD ctrl = XTP_REPORT_ITEM_CTRL_NULL, CString table = _T(""), BOOL header = FALSE, BOOL editable = TRUE, DWORD_PTR ptr = NULL, DWORD alignment = xtpItemControlUnknown)
	{
		m_column = column;
		m_ctrl = ctrl;
		m_table = table;
	...
	RecordItemCtrlData(const RecordItemCtrlData& src)
	{
	...
	RecordItemCtrlData& operator=(const RecordItemCtrlData& src)
	{
		m_column = src.m_column;
		m_ctrl = src.m_ctrl;
		m_table = src.m_table;
...
typedef xtp_vector<RecordItemCtrlData> RecordItemCtrlDataList;
...
public:
	...
	void DataBindRecordset(XTPREPORTMSADODB::_RecordsetPtr pRst = NULL, BOOL bInitRecordItemControlDataList = TRUE);
	...
	RecordItemCtrlDataList& GetrRecordItemCtrlDataList();
	void AddRecordItemCtrlData(RecordItemCtrlData& itemCtrlData);
	void DelRecordItemCtrlData(int index);
	void InitRecordItemControlDataList();
	void SetRecordItemControl();
	void SetRecordItemControl(RecordItemCtrlData& itemCtrlData);
	void SetRecordItemControl(RecordItemCtrlDataList& vecItemCtrlData);
	void SetRecordItemControl(int column, DWORD ctrl, CString table = _T(""), BOOL header = FALSE, BOOL editable = TRUE, DWORD_PTR ptr = NULL, DWORD alignment = xtpItemControlUnknown);
	void SetHeaderRecordItemControl();
	void SetHeaderRecordItemControl(RecordItemCtrlData& itemCtrlData);
	void SetHeaderRecordItemControl(RecordItemCtrlDataList& vecItemCtrlData);
	void SetHeaderRecordItemControl(int column, DWORD ctrl, CString table = _T(""), BOOL header = FALSE, BOOL editable = TRUE, DWORD_PTR ptr = NULL, DWORD alignment = xtpItemControlUnknown);
	void SetFooterRecordItemControl();
	void SetFooterRecordItemControl(RecordItemCtrlData& itemCtrlData);
	void SetFooterRecordItemControl(RecordItemCtrlDataList& vecItemCtrlData);
	void SetFooterRecordItemControl(int column, DWORD ctrl, CString table = _T(""), BOOL header = FALSE, BOOL editable = TRUE, DWORD_PTR ptr = NULL, DWORD alignment = xtpItemControlUnknown);
...
private:
	...
	RecordItemCtrlDataList m_vecRecordItemCtrlData;
};
